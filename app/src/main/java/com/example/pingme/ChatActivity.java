...
public class ChatActivity extends AppCompatActivity
{
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data)
    {
        ...
        if (requestCode == 438 && resultCode == RESULT_OK && data != null && data.getData() != null)
        {
            ...
            loadingBar.setMessage("Please wait, File is uploading");
                        ...
                        if(task.isSuccessful())
                        {
                            ...
                            filePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    messageTextBody.put("message",downloadedUrl);
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot)
                    {
                        if (dataSnapshot.child("userState").hasChild("state"))
                        {
                            ...
                            {
                                userLastSeen.setText("Last Seen: "+ date + "   Time: "+time);
                            }
...
//                });
    ...
    private void SendMessage()
    {
        ...
        {
            Toast.makeText(ChatActivity.this, "First Write you message...", Toast.LENGTH_SHORT).show();
        }
        else
        {
